                ...
                <section class="sidebar">
                    ...
                    <?php if ($this->session->userdata('user_group') == 1) { ?>
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li><a href="<?php echo site_url('admin/kategori') ?>"><i class="fa fa-file"></i> <span> Kelola Kategori</span></a></li>
                            <li><a href="<?php echo site_url('admin/supplier') ?>"><i class="fa fa-users"></i> <span> Kelola Supplier</span></a></li>
                            <li><a href="<?php echo site_url('admin/produk') ?>"><i class="fa fa-file"></i> <span> Kelola Produk</span></a></li>
                            <li><a href="<?php echo site_url('admin/transaksi') ?>"><i class="fa fa-file"></i> <span> Kelola Transaksi</span></a></li>
                            <li><a href="<?php echo site_url('admin/user'); ?>"><i class="fa fa-user"></i> Kelola Akun Pengguna</a></li>
                            <li><a href="<?php echo site_url('admin/slider'); ?>"><i class="fa fa-image"></i> Slider</a></li>
                            <li><a href="<?php echo site_url('admin/content/page/tentang'); ?>"><i class="fa fa-file"></i> Tentang</a></li>
                        </ul>
                    <?php } ?>
                </section>
            </aside>
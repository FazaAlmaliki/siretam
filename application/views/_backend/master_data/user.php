                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Email User" name="user_email" required="required">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for=""><b style="color: black">Email <span style="color:red">*</span></b></label>
                                                            <input type="text" class="form-control" placeholder="Email User" name="user_email" required="required" value="<?php echo $key->user_email; ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for=""><b style="color: black">Group <span style="color:red">*</span></b></label>
                                                            <select class="form-control" name="group_id" required>

<section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
        ...
        <ol>
            ...
            <?php if ($kategori_nama) { ?>
                <li><a href="#"><?php echo $kategori_nama[0]->kategori_nama; ?></a></li>
            <?php } else { ?>
        ...
        <?php if ($kategori_nama) { ?>
            <h2><?php echo $kategori_nama[0]->kategori_nama; ?></h2>
        <?php } else { ?>
            <h2>Semua</h2>
        <?php }  ?>
                        ...
                        <div class="col-lg-8 entries">
                            <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <article class="entry">
                                                ...
                                                <h2 class="entry-title">
                                                    <a href="<?php echo base_url(); ?>page/produk_detail/<?php echo $n->produk_id; ?>" style="font-size: 15px;"><?php echo $n->produk_nama; ?></a>
                                                </h2>
                                ...
                                <?php
                                    ...
                                    if ($kategori_nama) {
                                        echo "Tidak Ada " . $kategori_nama[0]->kategori_nama;
                                    } else {
